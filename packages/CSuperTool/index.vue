          ...
          <el-tooltip
            ...
            <div style="display: inline-block">
              <template v-if="btn.delete">
                <el-popover :key="btn.name" :value="btn.deleteActiv" width="160" placement="top">
          ...
          <el-dropdown-menu slot="dropdown">
            <template v-for="b in getHideBtnsGroup">
              <el-dropdown-item
                ...
                <svg-icon v-if="!b.eicon" :icon-class="b.icon" style="margin-right: 5px;"/>{{ b.title ? b.title : b.name }}
              </el-dropdown-item>
            </template>
          </el-dropdown-menu>
        </el-dropdown>
