          ...
          <el-form-item
            ...
            <template v-if="form.ctype === 'radio'">
              <el-radio-group
                ...
                <el-radio
                  ...
                  v-bind="radio"
                  :key="radio.label"
                  :style="radio.cstyle">{{ radio.value }}</el-radio>
              </el-radio-group>
            </template>
            ...
            <template v-else-if="form.ctype === 'checkbox'">
              <el-checkbox-group
                ...
                <el-checkbox
                  ...
                  v-bind="checkbox"
                  :key="checkbox.label"
                  :style="checkbox.cstyle">{{ checkbox.text || '' }}</el-checkbox>
              </el-checkbox-group>
            ...
            <template v-else-if="form.ctype === 'input'">
              <el-input
                ...
                :style="form.cstyle"
                @change="handleChange($event, form.callback)">
                <span v-if="form.prefix" class="cc-mar-l-6" slot="prefix">{{ form.prefix }}</span>
                <span v-if="form.suffix" class="cc-mar-r-6" slot="suffix">{{ form.suffix }}</span>
              </el-input>
            </template>
